...
async def _(event):
   ...
   # if input_str == "call":
    ...
    animation_chars = [
            ...
            "`Me: Yo this is` Your Dad,`Please Connect me to my son,Pavel Durov`",
            "`User Authorised.`",
            "`Calling Pavel Durov`  `At +916969696969`",
            "`Private  Call Connected...`",
            "`Me: Hello Sir, Please Ban This Telegram Account.`",    
            "`Pavel: May I Know Who Is This?`",
            "`Me: Yo Son, I Am` Your Dad",
            "`Pavel: OMG!!! Long time no see, Wassup Brother...\nI'll Make Sure That Guy Account Will Get Blocked Within 24Hrs.`",
            "`Me: Thanks, See You Later Dad.`",
            "`Pavel: Please Don't Thank Me Kid, Telegram Is Our's. Just Gimme A Call When You Become Free.`",
